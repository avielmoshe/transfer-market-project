...
function PlayerPage() {
  const dataOfNavSearch : DataForNavSearch = ["PROFILE" , " STATS" , "MARKET VALUES" , "TRANSFERS" , "RUMOURS" , "NATIONAL TEAM" , "NEWS" , "ACHIEVEMENTS" , "CAREER"]
  // const dataOfNavSearch : DataForNavSearch = ["OVERVIEW" , " SQUAD" , "FIXTURES" , "TRANSFERS & RUMOURS" , "INFORMATION & FACTS" , "STADIUM" , "HISTORY" , "NEWS" , "FORUM"]
  return (
    <>
