...
// מיפוי של כל העמדות למיקומים על המגרש
...
const FootballField: React.FC<PlayerProfile> = ({ playerMainPosition }) => {
  ...
  const playerStyle = positions[position] || { top: "50%", left: "50%" }; // Default to center
